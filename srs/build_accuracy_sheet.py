...
def save_acc_in_excel( algo, ticker, train_acc, test_acc, f1_train , f1_test ):
...
if( __name__ == "__main__" ):
    create_excel_file()
    #save_acc_in_excel("SVM", "MSFT", 0.99, 0.70, 0.80, 0.70 )
    
    
#import build_accuracy_sheet as save_acc
#save_acc.save_acc_in_excel( algo = "SVM", ticker = "AAPL",  train_acc = 0.99, test_acc = 0.70, f1_train = 0.80, f1_test = 0.7  )
